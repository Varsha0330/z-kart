...
public class UpdateProductSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Integer discount = Integer.parseInt(request.getParameter("dis"));

		ProductBean product = new ProductBean();
		product.setProdId(prodId);
		product.setBrand(prodName);
		product.setModal(prodInfo);
		product.setPrice(prodPrice);
		product.setStock(prodQuantity);
		product.setDiscount(discount);
		product.setCategory(prodType);
