...
import com.zoho.beans.CartBean;
import com.zoho.beans.OrderBean;
import com.zoho.beans.OrderDetails;
import com.zoho.beans.TransactionBean;
...
public class OrderServiceImpl implements OrderService {
	...
	public List<OrderDetails> getAllOrderDetails(String userEmailId) {
		...
		try {
			...
			ps = con.prepareStatement(
					"SELECT  p.pid as prodid, o.orderid as orderid, o.shipped as shipped, p.image as image, p.brand as pname, o.quantity as qty, o.amount as amount, t.time as time FROM orders o, product p, transactions t where o.orderid=t.transid and o.orderid = t.transid and p.pid=o.prodid and t.username=?");
