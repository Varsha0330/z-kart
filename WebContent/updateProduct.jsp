			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Brand</label> <input type="text"
							placeholder="Enter Brand Name" name="name" class="form-control"
							value="<%=product.getBrand()%>" id="last_name" required>
					</div>
					
					<div class="col-md-6 form-group">
						<%
						String ptype = product.getCategory();
						%>
					...
					<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Modal</label> <input type="text"
							value="<%=product.getModal()%>"
							placeholder="Enter Modal" name="info" class="form-control"
					...
					<div class="col-md-6 form-group">
						<label for="last_name">Discount </label> <input type="number"
							...
							id="last_name" name="dis" required>
					</div>
